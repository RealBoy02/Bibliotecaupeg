...
<head>
    ...
    <title>Fuentes Convencionales</title>
...
<section class="encabezado">
    ...
    <section class="namePage">
        ...
        <h2 class="mb-0" style="font-family: Impact; font-size: 3.5rem;">Fuentes Convencionales</h2>
...
<section id="libros">
    <div class="row">
        <?php
        $carpeta = '../archivos/Fuentes convencionales';
