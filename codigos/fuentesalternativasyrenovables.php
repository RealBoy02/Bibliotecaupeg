...
<head>
    ...
    <title>Fuentes Alternativas y Renovables</title>
...
<section class="encabezado">
    ...
    <section class="namePage">
        ...
        <h2 class="mb-0" style="font-family: Impact; font-size: 3.5rem;">Fuentes Alternativas y Renovables</h2>
...
<section id="libros">
    <div class="row">
        <?php
        $carpeta = '../archivos/Fuentes alternativas y renovables';
...
foreach ($archivos_permitidos as $archivo) {
    ...
    if (file_exists($ruta_completa_imagen_jpg)) {
        ...
        // Si no hay ninguna imagen, puedes mostrar un ícono predeterminado o un mensaje
