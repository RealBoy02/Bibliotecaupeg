...
<head>
    ...
    <title>AEficiencia Energética</title>
...
<section class="encabezado">
    ...
    <section class="namePage">
        ...
        <h2 class="mb-0" style="font-family: Impact; font-size: 3.5rem;">Eficiencia Energética</h2>
...
<section id="libros">
    <div class="row">
        <?php
        $carpeta = '../archivos/Eficiencia Energetica';
