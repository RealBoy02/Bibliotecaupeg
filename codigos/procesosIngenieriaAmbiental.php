...
<head>
    ...
    <title>Proceso de Ingeniería</title>
...
<section class="encabezado">
    ...
    <section class="namePage">
        <div class="contenedor-namePage">
            <h2 class="mb-0" style="font-family: Impact; font-size: 3.5rem;">Proceso de Ingeniería</h2>
...
<section id="libros">
    <div class="row">
        <?php
        $carpeta = '../archivos/Proceso de Ingenieria';
