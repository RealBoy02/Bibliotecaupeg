...
<head>
    ...
    <title>Tecnologías del Tratamiento</title>
...
<section class="encabezado">
    ...
    <section class="namePage">
        <div class="contenedor-namePage">
            <h2 class="mb-0" style="font-family: Impact; font-size: 3.5rem;">Tecnologías del Tratamiento</h2>
...
<section id="libros">
    <div class="row">
        <?php
        $carpeta = '../archivos/Tecnologias Tratamiento';
